  ...
  return (
    <div className="fixed inset-0 z-50 flex items-stretch sm:items-center justify-center">
      ...
      >
        ...
        <div className="flex-none sticky bottom-0 bg-white dark:bg-gray-800 p-4 sm:p-6 border-t dark:border-gray-700">
          <div className="flex justify-between max-w-[440px] mx-auto">
            <button
            ...
            <button
              ...
              className="flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm sm:text-base"
            >
